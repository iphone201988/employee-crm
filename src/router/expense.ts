...
expenseRouter.put("/update/:expenseId", authenticate, upload.array('file', 10), validate(expenseValidation.updateExpenseValidation), expenseController.updateExpense);
expenseRouter.delete("/delete/:expenseId", authenticate, expenseController.deleteExpense);
